...
contract AssociateProfitSplitter {
    ...
    //Constructor function allows us to avoid hard-coding addresses
    ...
    //Test to make sure contract balance is 0.
    function balance() public view returns(uint) {
        return address(this).balance;
    }

    function deposit() public payable { //Only owner can call this function
